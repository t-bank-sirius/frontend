...
export function CharacterCard({ name, subtitle, avatar, onClick }: CharacterCardProps) {
  return (
    <button
      onClick={onClick}
    ...
    >
      {/* Avatar */}
      <div className={`w-16 h-16 bg-yellow-600 rounded-2xl flex items-center justify-center text-2xl shadow-lg`}>
        {avatar}
      </div>
